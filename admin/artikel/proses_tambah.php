...
if ($_FILES['foto']['error'] == 0) {
	if ($_FILES['foto']['size'] < 10000000) {
		...
		$query = mysqli_query($koneksi, "INSERT INTO tbl_artikel (judul, isi, tanggal, foto) VALUES('$judul', '$isi', '$tanggal', '$nama_foto')") or die(mysqli_error($koneksi));
		...
		$_SESSION['gagal'] = 'ukuran gambar tidak boleh lebih dari 10000kb!';
		header('Location: index.php');
	}
}
