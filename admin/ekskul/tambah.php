...
<head>
	...
	<title>Tambah Data Ekstrakulikuler - SMA Darul Rohmah Laren</title>
					...
					<div class="card-body">
						<form method="POST" action="proses_tambah.php" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="nama" placeholder="Nama Ekskul" autocomplete="off" required="required" name="nama">
							</div>
							<div class="row">
								<div class="col">
									<div class="form-group">
