...
<body>
    ...
    <div class="container perGaleri col-8">
        <img src="images/galeri/<?= $galeri['foto1'] ?>" alt="Foto1" />
        <img src="images/galeri/<?= $galeri['foto2'] ?>" alt="Foto2" />
        <img src="images/galeri/<?= $galeri['foto3'] ?>" alt="Foto3" />
        <img src="images/galeri/<?= $galeri['foto4'] ?>" alt="Foto4" />
        <img src="images/galeri/<?= $galeri['foto5'] ?>" alt="Foto5" />
        <img src="images/galeri/<?= $galeri['foto6'] ?>" alt="Foto6" />
        <img src="images/galeri/<?= $galeri['foto7'] ?>" alt="Foto7" />
        <img src="images/galeri/<?= $galeri['foto8'] ?>" alt="Foto8" />
        <img src="images/galeri/<?= $galeri['foto9'] ?>" alt="Foto9" />
