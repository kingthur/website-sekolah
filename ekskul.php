...
<head>
    ...
    <title>Ekstrakulikuler SMA DARUL ROHMAH LAREN</title>
...
<body>
    ...
    <div class="title">
        ...
        <p class="text-center">Ekstrakulikuler Yang Ada Di SMA Darul Rohmah Laren</p>
    </div>

    <div class="container ekstrakulikuler">
        <?php while ($ekskul = mysqli_fetch_assoc($query)) : ?>
            <a href="#" class="perEkstrakulikuler">
                <img src="images/ekskul/<?= $ekskul['foto'] ?>" alt="<?= $ekskul['nama'] ?>" width="100%" class="">
                <p><?= $ekskul['nama'] ?></p>
            </a>
        <?php endwhile; ?>
    </div>
